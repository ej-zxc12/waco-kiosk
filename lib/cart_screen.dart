...
class _CartScreenState extends State<CartScreen>
  ...
  // Per-screen idle logic removed; global IdleWrapper handles inactivity
  ...
  // Idle handling removed; centralized in IdleWrapper

  // Removed empty dispose override (unnecessary)
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  isCartEmpty ? Colors.grey : const Color(0xFF6B4226),
                              foregroundColor: Colors.white,
                              padding: const EdgeInsets.symmetric(
                                horizontal: 24,
                                vertical: 14,
                            ...
                            child: Text(
                              isCartEmpty ? "Checkout Disabled" : "Proceed to Payment",
                              style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: isCartEmpty ? Colors.black54 : Colors.white,
                              ),
                            ),
                          ),
                        ],
